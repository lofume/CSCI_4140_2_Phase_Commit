...
CREATE SCHEMA IF NOT EXISTS `a4Database` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `a4Database`;
...
-- -----------------------------------------------------
-- Table `a4Database`.`X-log568`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `a4Database`.`X-log568` (
  `xlogId568` INT NOT NULL AUTO_INCREMENT,
  `xlogStart568` VARCHAR(45) NULL DEFAULT NULL,
  `xlogFinal568` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`xlogId568`),
  UNIQUE INDEX `xlogId_UNIQUE` (`xlogId568` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `a4Database`.`Y-log568`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `a4Database`.`Y-log568` (
  `ylogId568` INT NOT NULL AUTO_INCREMENT,
  `ylogStart568` VARCHAR(45) NULL DEFAULT NULL,
  `ylogFinal568` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`ylogId568`),
  UNIQUE INDEX `ylogId_UNIQUE` (`ylogId568` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `a4Database`.`Z-log568`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `a4Database`.`Z-log568` (
  `zlogId568` INT NOT NULL AUTO_INCREMENT,
  `zlogStart568` VARCHAR(45) NULL DEFAULT NULL,
  `zlogFinal568` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`zlogId568`),
  UNIQUE INDEX `zlogId_UNIQUE` (`zlogId568` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Creating X-log568 for Company X
-- -----------------------------------------------------
INSERT INTO `X-log568` (xlogId568, xlogStart568, xlogFinal568)
VALUES ('1', 'Get Ready X', 'Ready to Commit X');
...
-- -----------------------------------------------------
-- Creating Y-log568 for Company Y
-- -----------------------------------------------------
INSERT INTO `Y-log568` (ylogId568, ylogStart568, ylogFinal568)
VALUES ('1', 'Get Ready Y', 'Ready to Commit Y');
...
-- -----------------------------------------------------
-- Creating Z-log568 for Company Z
-- -----------------------------------------------------
INSERT INTO `Z-log568` (zlogId568, zlogStart568, zlogFinal568)
VALUES ('1', 'Get Ready Z', 'Ready to Commit Z');
